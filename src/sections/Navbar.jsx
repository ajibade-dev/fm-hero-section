...
const Navbar = () => {
    // the useState for the dropdown for the the navbar
 const [buttonOpen, setButtonOpen] = useState(false);
 const [secondButton, setSecondButton] = useState(false);

//  the useState for the mobile navBar
 ...
 const handleNav = () => {
  ...
  return (
    <div className={openMenu ? 'bg-almost-white flex items-center justify-between overlay-gray w-full' :  'bg-almost-white mx-auto flex items-center justify-between'}>
        {/* Navbar for desktop */}
        <div className='flex justify-between items-center px-8 py-6 gap-5'>
            ...
            <div className='hidden lg:flex flex-row gap-10 items-center pl-10'>
                {/* the dropdown */}
                {/* first one */}
                <div className='relative flex gap-3 items-center cursor-pointer' onClick={() => setButtonOpen(!buttonOpen)}>
                <h3 className='font-epilogue text-base font-medium text-gray-600 active:text-almost-black hover:text-almost-black'>Features</h3>
                {buttonOpen ? (
                ...
                {buttonOpen && <div className='absolute flex-col bg-white shadow-sm shadow-black rounded-md px-6 py-4 top-16 left-20 justify-center items-center group'>
                    {/* todo list */}
                    ...
                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Todo List</h3>
                    </div>
                    ...
                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Calendars</h3>
                    </div>
                    ...
                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Reminders</h3>
                    </div>

                    {/* planning */}
                    <div className='justify-between flex gap-5 mb-2'>
                    ...
                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Planning</h3>
                    </div>
                </div>}
                    
                    {/* second one */}
                <div className='flex gap-3 items-center cursor-pointer' onClick={() => setSecondButton(!secondButton)}>
                <h3 className='font-epilogue text-base font-medium text-gray-600 active:text-almost-black hover:text-almost-black'>Company</h3>
                {secondButton ? (
                    <svg width="10" height="7" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                ) : (
                    <svg width="10" height="7" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                )}
                </div>

                 {/* the dropdown elements the second one */}
                 {secondButton && <div className='absolute flex-col bg-white shadow-sm shadow-black rounded-md px-6 py-4 top-16 left-60 justify-start items-start'>
                    {/* History */}
                    <div className='justify-center flex gap-7 mb-2'>
                   

                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>History</h3>
                    </div>

                        {/* Our Team */}
                    <div className='justify-center flex gap-7 mb-2'>
                    
                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Our Team</h3>
                    </div>

                    {/* Blog */}
                    <div className='justify-center flex gap-7 mb-2'>

                    <h3 className='font-epilogue text-gray-600 font-medium text-base'>Blog</h3>
                    </div>
                </div>}

                <h3 className='font-epilogue text-base font-medium text-gray-600 active:text-almost-black hover:text-almost-black'>Careers</h3>

                <h3 className='font-epilogue text-base font-medium text-gray-600 active:text-almost-black hover:text-almost-black'>About</h3>
            </div>
            
        </div>

            {/* the buttons */}
            <div className='lg:flex hidden justify-end gap-4 mr-6'>
                <button className='font-epilogue text-base font-medium text-gray-600 hover:text-almost-black ro border-2 rounded-xl border-gray-600 hover:border-almost-black px-6 py-2'>Login</button>

                <button className='font-epilogue text-base font-medium text-gray-600 hover:text-almost-black ro border-2 rounded-xl border-gray-600 hover:border-almost-black px-6 py-2'>Register</button>
            </div>

           
           
             {/* navbar for small Screen */}
             <div className='flex lg:hidden mx-10' onClick={handleNav}>
                {/* navbar icon to open */}
                ...
                {/* the menu for small screens */}
            
            <div className={openMenu ? 'fixed h-full top-0 right-0 w-[50%] transition z-10 ease-in-out duration-300 shadow-lg shadow-black bg-almost-white' :'right-[-100%] fixed'}>

                {/* the close buttons for small screens */}
                    <div className={openMenu ? 'absolute right-10 top-6 cursor-pointer' : 'fixed right-[-100%]'} onClick={handleNav}>
                    ...
                    <div className='mt-20 flex flex-col gap-10 items-center pl-10 mx-auto'>
                {/* the dropdown */}
                {/* first one */}
                <div className=' relative flex gap-3 items-center cursor-pointer' onClick={() => setButtonOpen(!buttonOpen)}>
                <h3 className='font-epilogue text-base font-medium text-gray-600 active:text-almost-black hover:text-almost-black'>Features</h3>
            ...
            {/* the buttons */}
            <div className='flex  flex-col justify-end gap-8 mx-10 mt-10'>
                <button className='font-epilogue text-base font-medium text-gray-600 hover:text-almost-black ro border-2 rounded-xl border-gray-600 hover:border-almost-black px-6 py-2'>Login</button>
